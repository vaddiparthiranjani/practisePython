# Python class BankAccount with attributes like account_number, balance, date_of_opening and customer_name,
...
ac_no_1 = BankAccount(2345, "01-01-2011", 1000, "Ranjani")
ac_no_2 = BankAccount(1234, "11-03-2011", 2000, "Anagha")
ac_no_3 = BankAccount(2312, "12-01-2009", 3000, "Ananya")
ac_no_4 = BankAccount(1395, "01-01-2011", 3000, "Sahasra")
ac_no_5 = BankAccount(6345, "01-05-2011", 4000, "Samipya")
